...
import { Code, Star, Cloud } from "lucide-react";
...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      const decodedRedirect = redirectTo
        ...
        <div className="text-center mb-8">
          <Link href="/">
            <div className="inline-block">
              <div className="w-20 h-20 bg-primary rounded-md flex items-center justify-center text-white mx-auto mb-4">
                <Code size={40} />
              </div>
            </div>
          </Link>
          <h1 className="font-pixel-heading text-3xl text-gradient mb-2">
            Login
          </h1>
